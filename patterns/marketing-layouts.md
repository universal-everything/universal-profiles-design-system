...
| Deck section and closing slides (16:9) | One of the six slides-v2 background families (`../assets/generated/backgrounds/slides-v2/`), the same family through a section, light or dark with the theme; copy inside the family's measured safe zone (`../assets/generated/backgrounds/README.md`); iridescent horizon for dividers and closings. |
...
- Backgrounds are either address-derived (linear or aura) or the original soft-object, title and slides-v2 images with recorded provenance. No neon, no dreamscapes, no stock people.
...
SRC-POSTER-2025, SRC-NFTNYC-2026, SRC-FIGMA-UP-BOARD social templates (1131:22735, 1131:27438), SRC-GENERATED-IMAGES (IB-10 and IB-12 backgrounds), SRC-FIGMA-MOBILE-UPDATES (exported screens, decision 0011).
