...
| Deck slide | 1920 by 1080 (16 by 9) | Left 55 percent text-safe on title backgrounds; per-family measured zones for the slides-v2 backgrounds in `../assets/generated/backgrounds/README.md` (left half, right half, centre-left band, upper left, centre column, upper left); page number bottom right; tracked label top left | Right half, or where the family's subject sits | header row |
...
- Copy sits in the quiet area of the image; the delivered heroes keep the left 42 percent empty, the title backgrounds the left 55 percent, and every slides-v2 background declares its zone in the provenance record, where the validator measures it (mean luminance at least 200 for light and at most 64 for dark files, deviation at most 20).
